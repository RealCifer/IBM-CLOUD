...
const Footer = () => {
    return (
        <div>
            <footer className="text-black body-font bg-yellow-400">
                <div className="container px-5 py-5 mx-auto flex items-center sm:flex-row flex-col">
                    
                    <a className="flex title-font font-medium items-center md:justify-start justify-center text-black">
                        <span className="text-xl font-bold" style={{ fontFamily: "'Lobster', cursive" }}>
                            CLOUD-STORE
                        </span>
                    </a>
                    ...
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                        <a className="text-black cursor-pointer" href="https://www.instagram.com">
                        ...
                        <a className="ml-3 text-black cursor-pointer" href="https://www.instagram.com">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                                className="w-5 h-5" viewBox="0 0 24 24">
