    ...
    return (
        <Layout>
            ...
            <header className="text-white text-center py-6 bg-gradient-to-r from-pink-500 to-purple-500 text-2xl font-semibold font-poppins tracking-wide shadow-lg">
                ✨ Cloud Store - <span className="glowing-text">BOOKS</span> ✨
            </header>
            ...
            <div className="container mx-auto px-5 py-10">
                ...
                {loading && <p className="text-center text-gray-500">Loading books products...</p>}
                ...
                {!loading && !error && products.length > 0 ? (
                    ...
                    !loading && !error && <p className="text-center text-gray-500">No books found.</p>
                )}
            </div>
        </Layout>
    );
